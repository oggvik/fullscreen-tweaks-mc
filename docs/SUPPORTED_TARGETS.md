...
| `1.14.4` | Fabric | 8 | `>=1.14 <1.14.5` | GLFW controller and settings screen |
| `1.15.2` | Fabric | 8 | `>=1.15 <1.15.3` | GLFW controller and settings screen |
| `1.16.5` | Fabric | 8 | `>=1.16 <1.16.6` | GLFW controller and settings screen |
| `1.16.5` | Forge standalone | 8 | exact `1.16.5` | `MainWindow` mixin; build runs on JDK 17 |
| `1.17.1` | Fabric | 16 | `>=1.17 <1.17.2` | GLFW controller and settings screen |
| `1.17.1` | Forge | 16 | `[1.17,1.17.2)` | Version-specific `Window` mixins |
| `1.18.2` | Fabric | 17 | `>=1.18 <1.18.3` | GLFW controller and settings screen |
| `1.18.2` | Forge | 17 | `[1.18,1.18.3)` | Version-specific `Window` mixins |
| `1.19.2` | Fabric | 17 | `>=1.19 <1.19.3` | GLFW controller and settings screen |
| `1.19.2` | Forge | 17 | `[1.19,1.19.3)` | Version-specific `Window` mixins |
| `1.19.4` | Fabric | 17 | `>=1.19 <1.19.5` | GLFW controller and settings screen |
| `1.19.4` | Forge | 17 | `[1.19,1.19.5)` | Version-specific `Window` mixins |
| `1.20.1` | Fabric | 17 | `>=1.20 <1.20.7` | Compiled for 1.20.1; broad metadata overlaps the 1.20.6 jar |
...
| `1.20.6` | Fabric | 21 | `>=1.20 <1.20.7` | Compiled for 1.20.6 with `GuiGraphics` |
| `1.20.6` | NeoForge | 21 | `[1.20.6,1.20.7)` | Version-specific `Window` mixins |
| `1.21.1` | Fabric | 21 | `>=1.21 <1.21.2` | 1.21.1 handle and screen APIs |
| `1.21.1` | NeoForge | 21 | `[1.21,1.21.9)` | Compiled for 1.21.1; broad metadata includes 1.21–1.21.8 |
| `1.21.11` | Fabric | 21 | `>=1.21 <1.21.12` | New identifier and window-handle mappings |
| `1.21.11` | NeoForge | 21 | `[1.21.9,1.21.12)` | Compiled for 1.21.11; metadata includes 1.21.9–1.21.11 |
| `26.1.2` | Fabric | 25 | `>=26.1 <26.1.3` | Extractor-era GLFW implementation |
| `26.1.2` | NeoForge | 25 | `[26.1,26.1.3)` | Extractor-era GLFW implementation |
| `26.2` | Fabric | 25 | `>=26.2 <26.3` | Extractor-era GLFW implementation |
| `26.2` | NeoForge | 25 | `[26.2,26.3)` | Extractor-era GLFW implementation |
| `26.3-snapshot-1`–`-3` | Fabric | 25 | exact `26.3-alpha.1`–`.3` | Extractor-era GLFW implementation |
...
| BTA `8.0.1` | Babric standalone | 17 | `*` | Full 2.0.1 focus-loss and loading-window controls integrated into BTA's Video page; BTA owns native versus borderless selection; build runs on JDK 21 |

Fabric, Forge, and NeoForge artifacts use the LWJGL/GLFW libraries shipped by Minecraft. The BTA ports explicitly depend on their BTA-compatible LWJGL artifacts.
