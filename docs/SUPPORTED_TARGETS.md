...
| `26.3-snapshot-4` | Fabric | 25 | exact `26.3-alpha.4` | SDL3 loading-window controls; focus-loss policy is unnecessary |
| `26.3` | Fabric | 25 | `>=26.3 <26.4` | SDL3 loading-window controls; focus-loss policy is unnecessary |
| `26.3` | NeoForge | 25 | `[26.3,26.4)` | SDL3 loading-window controls after NeoForge window handoff; focus-loss policy is unnecessary |
