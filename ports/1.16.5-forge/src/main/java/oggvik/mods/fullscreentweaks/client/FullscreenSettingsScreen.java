...
public final class FullscreenSettingsScreen extends Screen {
    ...
    *//*?}*/
    ...
    public FullscreenSettingsScreen(Screen parent) {
        ...
        *//*?} else {*/
        super(new TranslationTextComponent("fullscreen_tweaks.settings.title"));
        /*?}*/
        this.parent = parent;
    }
    ...
    *//*?} else {*/
    ...
    public void render(MatrixStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        if (!compactLayout) {
            drawCenteredString(poseStack, this.font,
                    new TranslationTextComponent("fullscreen_tweaks.option.fullscreen_mode"),
                    this.width / 2, fullscreenModeLabelY, 0xA0A0A0);
            drawCenteredString(poseStack, this.font,
                    new TranslationTextComponent("fullscreen_tweaks.option.loading_screen_mode"),
                    this.width / 2, loadingModeLabelY, 0xA0A0A0);
        }
        super.render(poseStack, mouseX, mouseY, partialTick);
    }
